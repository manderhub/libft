...
DEPS=libft.h
OBJ= ft_bzero.o ft_isalpha.o ft_isalnum.o ft_isascii.o ft_isdigit.o ft_isprint.o ft_memcpy.o ft_memset.o ft_strlcat.o ft_strlen.o \
	ft_strncmp.o ft_tolower.o ft_toupper.o tests.o
